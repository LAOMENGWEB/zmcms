...
sql = "select * from al where id = "&id&""
...
call DeleteFile("../html/"&alName&""&Separated&""&pone&""&Separated&""&ID&""&Separated&"1.html")

else
arrContent=split(rs("content"),"[zmcmsfy]")
pages=Ubound(arrContent)+1
for i=1 to pages
call DeleteFile("../html/"&alName&""&Separated&""&pone&""&Separated&""&ID&""&Separated&""&i&".html")
next
end if
