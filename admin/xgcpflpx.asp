...
sql1="select * from cpclass where id="&request.QueryString("id")&""
...
call addlog("设置"&chanpin&"栏目排序")
end if
Set rs = server.CreateObject("adodb.recordset")
sql2 = "select * from cpclass where id = "&request.QueryString("id")&""
...
<form id="form1" name="form1" method="post" action="xgcpflpx.asp?id=<%=rs("id")%>">
  <label>
