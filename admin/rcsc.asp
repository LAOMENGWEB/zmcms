...
call DeleteFile("../html/"&zpName&""&Separated&""&ID&""&Separated&"1.html")

else
arrContent=split(rs("HrDetail"),"[zmcmsfy]")
pages=Ubound(arrContent)+1
for i=1 to pages
call DeleteFile("../html/"&zpName&""&Separated&""&ID&""&Separated&""&i&".html")
next
end if
...
call addlog("人才删除")
response.Write "<script language=javascript>alert(""删除成功！"");window.location.href=""zp.asp""</script>"
