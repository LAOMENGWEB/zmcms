...
sql1="select * from meun where id="&request.QueryString("id")&""
...
Set rs = server.CreateObject("adodb.recordset")
sql2 = "select * from meun where id = "&request.QueryString("id")&""
...
<form id="form1" name="form1" method="post" action="xgdhpx.asp?id=<%=rs("id")%>">
  <label>
