...
session("sendtime")=""
  %>
  <form id="form1" name="form1" method="post" action="sendmemberemail.asp?l=pumailgo" class="checkform">



<table width="100%" border="0" cellpadding="0" cellspacing="0"  align="center" class="table1">
<tr>
 <td  style="border-bottom:none;border-right:none;color:#cccccc"><div align="center">所有订阅用户邮件发送  <span id="yuyan" style="margin-left:20px"></span></div></td>
</tr>
</table>
...
<table border="0" align="center" cellpadding="0" cellspacing="0" width="99%" class="dtable3">
 ...
 <div class="dmeun" ><a href="sendmemberemail.asp?l=somail" target="main" >所有订阅用户</a></div>
 <div class="dmeun" style=" background:#eeeeee; color:#999999"><a href="sendhyemail.asp?l=somail" target="main" style=" color:#999999">会员发送</a></div>
  ...
  <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="dtable4">
   ...
   <tr>
      <td width="11%">邮件主题 ：</td>
	  <td width="89%">
        <input name="title" type="text" id="title" size="40" datatype="*" nullmsg="邮件主题不能为空"/>
      </td>
    </tr>
	 <script>
 var editor1;
...
<table width="99%" border="0" align="center" cellpadding="10" cellspacing="1" bgcolor="#f9f9f9">
    <tr>
	  ...
	  <iframe name="send" width="100%" height="300" marginwidth="0" marginheight="0" frameborder=no src="email_send.asp?pageid=1&totalcount=0"> 浏览器不支持嵌入式框架，或被配置为不显示嵌入式框架。</iframe></td>
    </tr>
