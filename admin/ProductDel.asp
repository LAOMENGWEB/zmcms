...
call DeleteFile("../html/"&ProductName&""&Separated&""&pone&""&Separated&""&ID&""&Separated&"1.html")
else
arrContent=split(rs("content"),"[zmcmsfy]")
pages=Ubound(arrContent)+1
for i=1 to pages
call DeleteFile("../html/"&ProductName&""&Separated&""&pone&""&Separated&""&ID&""&Separated&""&i&".html")
next
end if
...
conn.Execute ( "delete from Product_price where product_id="&id&"" )
