...
Set rs = server.CreateObject("adodb.recordset")
rs.open "Select * From SelectType Where s_name='" & s_name & "'",conn,1,3
if not (rs.bof and rs.EOF) then
response.Write "<script language=javascript>alert(""属性名称已经存在"");window.history.back(-1);</script>"
response.End
end if
rs.addnew
...
response.Write "<script language=javascript>alert(""恭喜您添加成功"");window.location.href=""selectvaule.asp""</script>"
...
<tr>
 <td  style="border-bottom:none;border-right:none;color:#cccccc"><div align="center">添加属性类别  <span id="yuyan" style="margin-left:20px"></span></div></td>
</tr>
</table>
...
<tr > 
  ...
  <td width="89%">
    <input  name="s_name" type="text" id="s_name"  size="20"  datatype="*" nullmsg="属性类别名称不能为空"/> <font color="#FF0000">*</font></td>
</tr>
