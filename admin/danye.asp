...
<tr>
 <td  style="border-bottom:none;border-right:none;color:#cccccc"><div align="center"><%=danye%>管理 <span id="yuyan" style="margin-left:20px"></span></div></td>
</tr>
</table>
...
<tr>
 <td  style="border-bottom:none;border-right:none;"><div align="center"> <a href="dy.asp" target="main" style="color:#ffffff"><%=danye%>列表管理</a></div></td>
</tr>
</table></td>
    <td style="border:none"><table border="0" cellpadding="0" cellspacing="0"  style=" background: #28b576;width:120px;height:100px;border:1px #eeeeee solid; ">
<tr>
 <td  style="border-bottom:none;border-right:none;"><div align="center"> <a href="dyadd.asp" target="main" style="color:#ffffff">添加<%=danye%></a></div></td>
</tr>
</table></td>
    <td style="border:none"><table border="0" cellpadding="0" cellspacing="0"  style=" background: #28b576;width:120px;height:100px;border:1px #eeeeee solid; ">
<tr>
 <td  style="border-bottom:none;border-right:none;"><div align="center"> <a href="fl_dy.asp" target="main" style="color:#ffffff"><%=danye%>分类管理</a></div></td>
</tr>
</table></td>
  </tr>
</table>
