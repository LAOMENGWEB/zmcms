...
sql1="select * from mnclass where id="&request.QueryString("id")&""
...
call addlog("设置单页栏目排序")
end if
Set rs = server.CreateObject("adodb.recordset")
sql2 = "select * from mnclass where id = "&request.QueryString("id")&""
...
<form id="form1" name="form1" method="post" action="xgdyflpx.asp?id=<%=rs("id")%>">
  <label>
