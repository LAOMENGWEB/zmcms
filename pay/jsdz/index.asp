        ...
        <form name=alipayment action=alipayapi.asp method=post target="_blank">
            <div id="body" style="clear:left">
                <dl class="content">
                    ...
                    <dd>
                        <span class="null-star">*</span>
                        <input name="WIDout_trade_no" value="<%=session("orderddh")%>" size="30" />
                        <span>商户网站订单系统中唯一订单号，必填</span>                    </dd>
                    <dt>订单名称：</dt>
                    <dd>
                  <span class="null-star">*</span>
                  <input name="WIDsubject" value="11111" size="30" />
                  <span>必填</span>                    </dd>
                    <dt>付款金额：</dt>
                    <dd>
                        <span class="null-star">*</span>
...
：</dt>
                    ...
                    <dd>
                        ...
                        <span>需以http://开头的完整路径，例如：http://www.xxx.com/myorder.html</span>                    </dd>
                    <dt></dt>
                    <dd>
