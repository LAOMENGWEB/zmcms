var sf_mess_tween = {
    init: function() {
        ...
        sf_mess_lib.getElement(SF_MESS_HEAD_ID).onclick = function(e) {
            sf_mess_tween.doTween();
        }
    },
    duration: 30,
...
var sf_mess_layout = {
    ...
    fixMessageBoardPosition: function() {
        ...
        self.mbWrap.style.top = parseInt(page.scrollTop) + 100 + 'px';
    }
}
