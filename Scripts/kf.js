...
{
	window.open('http://wpa.qq.com/msgrd?V=1&amp;Uin='+kfguin+'&amp;Site=CompanyCMS&amp;Menu=yes', '_blank', 'height=544, width=644, toolbar=no, scrollbars=no, menubar=no, status=no');
	if(flag==1)
	{
		kf_hidekfpopup();
	}
